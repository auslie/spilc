<title>SpilcHosting</title>
<marquee behavior="scroll" direction="left">...(==Welcome! This website is little bit on developement...==)... </marquee>
<style>
<marquee behavior="scroll" direction="left" scrollamount="1">Just</marquee>
<marquee behavior="scroll" direction="left" scrollamount="10">Believe...</marquee>
<marquee behavior="scroll" direction="left" scrollamount="20">On</marquee>
<marquee behavior="scroll" direction="left" scrollamount="50">Yourself</marquee>
.scroll-left {
 height: 50px;	
 overflow: hidden;
 position: relative;
...
<p>Welcome to our Fancy made Hosting Website  </p>
</div>
Welcome! This website is little bit on developement... Enjoy exploring and catting for now! by SpilC and Medu and other guys.
...
<div style="max-height:1000px;font-family:Cursive;font-size:14pt;color:black;">
<marquee style="position:relative;left:122px;top:0px;height:397px;" scrollamount="6" direction="down">doge</marquee>
<marquee style="position:relative;left:8px;top:-397px;height:175px;" scrollamount="4" direction="down">Sus</marquee>
<marquee style="position:relative;left:151px;top:-550px;height:235px;" scrollamount="5" direction="down">Amogus</marquee>
<marquee style="position:relative;left:51px;top:-735px;height:161px;" direction="down">So COOL</marquee>
<marquee style="position:relative;left:124px;top:-961px;height:337px;" direction="down">pls halp!!11</marquee>
<marquee style="position:relative;left:122px;top:-1213px;height:397px;" scrollamount="7" direction="down">my pc is doin weird!!11</marquee>
<marquee style="position:relative;left:55px;top:-1691px;height:231px;" scrollamount="5" direction="down">what da dog doin</marquee>
<marquee style="position:relative;left:98px;top:-1900px;height:127px;" scrollamount="6" direction="down">lol xd</marquee>
<marquee style="position:relative;left:93px;top:-2100px;height:355px;" scrollamount="1" direction="down">best site ever</marquee>
<marquee style="position:relative;left:279px;top:-2504px;height:475px;" scrollamount="4" direction="down">DUD SO COOL!!!!!</marquee>
<marquee style="position:relative;left:185px;top:-2907px;height:373px;" scrollamount="1" direction="down">Amogus</marquee>
<marquee style="position:relative;left:140px;top:-3200px;height:296px;" scrollamount="7" direction="down">Best hosting ever</marquee>
<marquee style="position:relative;left:26px;top:-3500px;height:300px;" scrollamount="3" direction="down">amogus on the moon!!!11</marquee>
<marquee style="position:relative;left:22px;top:-3800px;height:253px;" scrollamount="6" direction="down">lol jk</marquee>
<marquee style="position:relative;left:211px;top:-4040px;height:325px;" scrollamount="7" direction="down">bruh</marquee>
<marquee style="position:relative;left:203px;top:-4400px;height:481px;" scrollamount="5" direction="down">troll</marquee>
<marquee style="position:relative;left:107px;top:-4900px;height:330px;" scrollamount="2" direction="down">lmao.com</marquee>
<marquee style="position:relative;left:132px;top:-5205px;height:331px;" scrollamount="5" direction="down">coolest site ever in da world!!!!!!!111</marquee>
<marquee style="position:relative;left:57px;top:-5500px;height:94px;" scrollamount="5" direction="down">better than ayehosting dude!!1</marquee>
<marquee style="position:relative;left:5px;top:-5600px;height:471px;" direction="down">Obamium</marquee>
<marquee style="position:relative;left:317px;top:-6003px;height:480px;" scrollamount="5" direction="down">THUMBS UP FOR BARACC OBAMIUM!!1111!!!!!</marquee>
</div>
